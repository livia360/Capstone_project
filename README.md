...
**Comparison of roc_auc scores between the models.**  
 ...
 - If we would have more details/data about the campaigns, like their time spans, feed into the model training, we may get more accuate model and better prediction for the effectiveness of the champaign.
