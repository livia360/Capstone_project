...
Customer personality analysis is an interesting topic for companies. The dataset used is a competition dataset from Kaggle between 2012 and 2014. To solve a binary classification problem, this notebook has trained five different machine learning models to learn this dataset, and predict the customers’ response to the last 6th marketing campaign (accepting the offer or not) when we already have 5 campaigns.
